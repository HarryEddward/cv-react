...
export const HomeView = () => {
    ...
    useEffect(() => {
        const font = new FontFaceObserver('ECKHART_display_black');
            ...
            {fontLoaded && (
                <>
                    ...
                    <div className='hidden xl:block w-full h-[1px]'>
                        {laptopLoaded && (
                        <h1 className='w-full font-black text-[50vh] text-center font-ECKHART_display_black text-black'>
                    ...
                    <div className='w-full h-[1px] text-black block md:hidden'>
                        ...
                        <div className='text-center'>
                            <h1 className='pt-10 w-full font-black text-8xl text-center font-ECKHART_display_black text-black'>
                                <SplitText text="Adrian" />
                            </h1>
                    ...
                    <div className="block md:hidden">
                        <div className=''>
                            <div className='w-[800px] max-w-full h-[2px] bg-slate-300 mx-auto'/>
